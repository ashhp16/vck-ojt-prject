            ...
            <section className="admit-head">
                ...
                <section className="list">
                    ...
                    <section className="para">
                        <p>For detailed information on postgraduate program admissions, specific program syllabi, and fee structures, please visit our Courses page or Contact</p>
                    </section>
                 </div>
                 </div>
               )
